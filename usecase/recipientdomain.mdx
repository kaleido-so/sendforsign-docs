...
Now, any recipient link for your account will be transformed into the following structure: `yourdomain.com` + `sharing` + `recipientKey`.

Example: `https://yourdomain.com/sharing/8269-4d32-4716-86d3-159a9cad`.
