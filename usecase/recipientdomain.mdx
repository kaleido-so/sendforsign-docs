...
3. Go to your Sendforsign dashboard.

Now you can navigate to `Settings`, then `Branding`, and add the domain you just created to the line `Recipient link domain`, and save the changes:

<Frame caption="Sendforsign settings">
  <img src="/usecase/img/13.png" />
</Frame>

After this, any recipient link will be created with this domain.
