...
- Get a platform API key and Secret key (representing your platform).
...
## Get a platform API key and Secret key

To begin using Sendforsign and gain the capability to generate documents through our infrastructure, 
you need to create your SFS account. Creating a new account will automatically generate a unique API key and Secret key for you.
...
containing the `apiKey` and `secretKey` values you obtained in the previous step.
...
SFS responds back with a **400 Bad Request** error:
