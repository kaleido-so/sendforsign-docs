---
title: "Send contract"
description: "Send existing contract to recipients."
---

Sending a contract, use the API key from the personal account in the header.
...
<RequestExample>
```bash cURL
curl -X POST 'https://api.sendforsign.com/v1/email' \
