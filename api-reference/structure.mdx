...
Platform development teams connect to the SFS API using admin-level access tokens. 
...
serves one or more clients. Using a client's ID, it is possible to gain root access to all resources exclusively 
