...
To authenticate you need to add an Authorization header with the contents of the header 
being `Bearer 123456789` where `123456789` is your [Client Token](/api-reference/authentication#creating-client-tokens).
```bash
