...
| `isModal`           | `boolean`      |`false`  |If `false`, every click on the table row will save the templateKey to local storage. If `true`, a click on the table row will open a modal window with the template rendered.|
